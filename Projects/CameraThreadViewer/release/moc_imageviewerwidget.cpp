...
QT_MOC_LITERAL(1, 18, 10), // "FPSupdated"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 18), // "RightButtonPressed"
QT_MOC_LITERAL(4, 49, 13), // "doubleClicked"
QT_MOC_LITERAL(5, 63, 7), // "clicked"
QT_MOC_LITERAL(6, 71, 10), // "keyPressed"
QT_MOC_LITERAL(7, 82, 10), // "QKeyEvent*"
QT_MOC_LITERAL(8, 93, 9) // "updateFPS"

    },
    "ImageViewerWidget\0FPSupdated\0\0"
    "RightButtonPressed\0doubleClicked\0"
    "clicked\0keyPressed\0QKeyEvent*\0updateFPS"
};
...
void ImageViewerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ImageViewerWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewerWidget::FPSupdated)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ImageViewerWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewerWidget::RightButtonPressed)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ImageViewerWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewerWidget::doubleClicked)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (ImageViewerWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewerWidget::clicked)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (ImageViewerWidget::*_t)(QKeyEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewerWidget::keyPressed)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject ImageViewerWidget::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_ImageViewerWidget.data,
...
// SIGNAL 0
void ImageViewerWidget::FPSupdated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void ImageViewerWidget::RightButtonPressed()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void ImageViewerWidget::doubleClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 2, Q_NULLPTR);
}

// SIGNAL 3
void ImageViewerWidget::clicked()
{
    QMetaObject::activate(this, &staticMetaObject, 3, Q_NULLPTR);
}

// SIGNAL 4
void ImageViewerWidget::keyPressed(QKeyEvent * _t1)
{
